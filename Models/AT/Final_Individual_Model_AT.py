...
dataX = np.loadtxt("Directory/DatosAT_X.txt")
datay = np.loadtxt("Directory/DatosAT_Y.txt")
...
# We normalize the inputs to [0,1] and the outputs to [0.05,0.95]. Others values can be tried.
...
scaler2 = MinMaxScaler(feature_range=(0.05,0.95)) 
...
ann = tf.keras.models.load_model("Directory/model_17.h5")
