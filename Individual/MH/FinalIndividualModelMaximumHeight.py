...
# We normalize the inputs to [0,1] and the outputs to [0.02,0.98]. We have the scalers saved, you just need to load them.
...
ann = tf.keras.models.load_model(r"Directory\model_23.h5")
